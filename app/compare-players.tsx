    ...
    <SafeAreaView style={s.safe}>
      ...
      <ScrollView style={s.scroll} contentContainerStyle={s.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={s.searchWrap}>
          <Ionicons name="search" size={18} color={T.textSecondary} style={s.searchIcon} />
          <TextInput
            style={s.searchInput}
        ...
        <View style={s.section}>
          ...
          >
            ...
            <View style={[s.statDataCell, s.oppCol, { flexDirection: 'row', justifyContent: 'center', gap: 4 }]}>
              ...
              <Ionicons name={surfaceExpanded ? 'chevron-up' : 'chevron-down'} size={14} color={T.textSecondary} />
            </View>
          </TouchableOpacity>
...
const s = StyleSheet.create({
  ...
  searchInput: { flex: 1, color: T.textPrimary, fontSize: 15, paddingVertical: 14 },
  searchHint: { fontSize: 13, color: T.textSecondary, textAlign: 'center', marginTop: 12, marginBottom: 4 },
  ...
  comingSoonTitle: { fontSize: 15, fontWeight: '600', color: T.textPrimary, marginBottom: 4 },
  comingSoonSub: { fontSize: 13, color: T.textSecondary },
  ...
  modeBtnText: { fontSize: 13, fontWeight: '600', color: T.textSecondary },
  ...
  rowEven: { backgroundColor: T.card },
  ...
  youCol: { backgroundColor: T.accentMuted },
  oppCol: {},

  colHeaderYou: { fontSize: 13, fontWeight: '700', color: T.accent, textAlign: 'center' },
  colHeaderOpp: { fontSize: 13, fontWeight: '700', color: T.textPrimary, textAlign: 'center' },
  previewBadge: {
    backgroundColor: T.cardBorder, borderRadius: 8,
    paddingHorizontal: 6, paddingVertical: 2, alignSelf: 'center', marginTop: 2,
  },
  previewBadgeText: { fontSize: 9, fontWeight: '700', color: T.textSecondary, textTransform: 'uppercase', letterSpacing: 0.5 },

  statValue: { fontSize: 14, fontWeight: '600', color: T.textPrimary, textAlign: 'center' },
  statNote: { fontSize: 9, color: T.textMuted, textAlign: 'center', marginTop: 2 },
  ...
  futureSep: { fontSize: 10, color: T.textMuted, textTransform: 'uppercase', letterSpacing: 0.8 },
});
